...
id: queercon-2016-queercon-13-badge-squid-cuttlefish-badge
layout: badge
...
year: 2016
makers:
- name: Evan Mackay, George Louthan, Jonathan Nelson, Jason Painter
summary: The 2016 Queercon badge (Queercon 13, at DEF CON 24) is a squid/cuttlefish-shaped PCB badge with a clear solder mask over black FR4 and curved, organic traces.
functions: Squid eyes made of 60 cyan LEDs display expressions; RGB LEDs light the tentacles in selectable patterns; an onboard 2.4 GHz radio lets badges "mate" with each other to learn patterns; a phototransistor auto-adjusts LED brightness.
look:
  colors:
  - black
  - clear
...
- label: Hackaday.io - An oral history of the shitty add-on standard
  ...
  kind: article
images:
- file: assets/images/badges/queercon-2016/queercon-13-badge-squid-cuttlefish-badge/7c3839b874.jpg
...
contact: {}
notes:
- Squid-shaped badge with 60 cyan eye LEDs, RGB tentacle LEDs, a 2.4GHz radio for badge-to-badge pattern sharing, phototransistor auto-brightness, and two head expansion ports for hat add-ons. Found by the event-year sweep, task queercon.
- 'Original sweep note: "Squid-shaped village badge Evan Mackay designed for Queer Con at DEF CON 23, cited in Vice''s badgelife history as an early independent village badge. Found by the event-year sweep, task general-2006."'
- Squid-shaped Queercon party badge for DC24 with 60 cyan eye LEDs, RGB tentacle LEDs, an 'ink' button that broadcasts patterns over 2.4GHz radio, and physical 'mating' connectors between badges. Found by the event-year sweep, task dc24-all.
status: listed
sources:
- kind: url
  url: https://hackaday.com/2016/08/10/what-we-learned-from-the-2016-queercon-badge/
