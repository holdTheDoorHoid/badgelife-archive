---
title: FLARE RACCOON PURPL3HAT Badge
id: dc33-flare-raccoon-purpl3hat-badge
layout: badge
parent: DC33
...
summary: A blinky badge made by Hackerware.io for the FLARE team at DEF CON 33 (2025), carrying a raccoon design and a "PURPL3HAT" name; specifics beyond the sheet listing could not be confirmed.
functions: Blinky
look:
  colors: []
  shape: null
...
make_your_own:
  ...
  eda_tool: null
links:
- label: flare.io/discord
  url: https://flare.io/discord
  kind: social
images: []
contact: {}
notes:
- 'Join the Flare Discord and keep an eye on #flarehackerweek channel.'
status: listed
sources:
- kind: sheet
  event: dc33
...
- kind: url
  ...
  accessed: '2026-09-06'
  note: The link from the sheet is a live Discord invite redirect; it is a generic invite page with no badge details visible without joining.
research:
  status: researched
  confidence: low
