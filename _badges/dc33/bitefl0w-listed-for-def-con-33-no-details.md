---
title: Bitefl0w (listed for DEF CON 33, no details)
id: dc33-bitefl0w-listed-for-def-con-33-no-details
layout: badge
parent: DC33
...
research:
  ...
  notes: >-
    ...
    or social account under this handle; unrelated results for a similarly
    spelled diet-product brand ("BiteFlow") were excluded as not relevant.
    hackaday.io/bitefl0w and github.com/bitefl0w both 404. Could not confirm
    what, if anything, this maker brought to DEF CON 33. Note: the same maker
    has an identical unresearched "listed, no details" entry for DEF CON 32
    (dc32-bitefl0w-listed-for-def-con-32-no-details), also with no findable
    project page as of this pass.
