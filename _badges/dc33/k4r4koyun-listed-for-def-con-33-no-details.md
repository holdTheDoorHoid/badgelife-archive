---
title: K4r4koyun (listed for DEF CON 33, no details)
id: dc33-k4r4koyun-listed-for-def-con-33-no-details
layout: badge
parent: DC33
...
links:
- kind: social
  label: K4r4koyun on GitHub
  url: https://github.com/k4r4koyun
- kind: repo
  label: "teETHernet SAO (DEF CON 32, same maker)"
...
- kind: sheet
  ...
  updated: ''
- kind: url
  url: https://github.com/k4r4koyun?tab=repositories
  title: k4r4koyun (Göktay) - GitHub repositories
  accessed: '2026-09-06'
  note: >-
    Confirms maker identity (Göktay, "security engineer and hardware
    enthusiast") and full repo list; no repository for a DEF CON 33 /
    2025 badge or SAO exists as of this check.
- kind: url
  url: https://github.com/k4r4koyun/DEFCON-32-teETHernet-SAO
  title: DEFCON-32-teETHernet-SAO
  accessed: '2026-09-06'
  note: >-
    Prior-year SAO by the same maker (ATMEGA328PB-AU, 9 side-mounted LEDs,
    dual ethernet jacks, UART CTF); repo contains no mention of a DC33
    follow-up.
- kind: url
  url: https://k4r4koyun.com/tag/defcon/
...
research:
  ...
  notes: >-
    The community sheet only listed the maker's handle for DC33 with no
    details, matching the "listed for DEF CON NN, no details" naming pattern.
    K4r4koyun (Göktay) is a real, identifiable maker with a documented history
    of hardware badges/SAOs: the "SCP Badge" for DEF CON 30 and the
    "teETHernet SAO" for DEF CON 32 (ATMEGA328PB-AU, 9 side LEDs, dual
