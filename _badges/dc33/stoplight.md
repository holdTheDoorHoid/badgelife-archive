...
year: 2025
makers:
- name: Diana Initiative / TechGirlMN
summary: ''
functions: Blinky lights, oled screen & rpi pico for shenanigans
look:
  colors: []
  shape: null
  themes: []
...
Stoplight is a DEF CON 33 (2025) SAO listed by the Diana Initiative / TechGirlMN on the community badge sheet, described there as featuring "blinky lights, oled screen & rpi pico for shenanigans." Per the sheet it was obtained with a $50-plus event ticket. No maker page, storefront listing, repo, or press coverage could be found to confirm details beyond what the sheet states, so most technical and availability fields remain unverified and are left blank.

The Diana Initiative is a nonprofit conference for women and underrepresented people in information security, held alongside DEF CON in Las Vegas; TechGirlMN (Chris) is a maker associated with the group's badge and SAO offerings in multiple years (see the group's other archive entries). Without additional sources, it isn't possible to say more about the Stoplight SAO's design, chip usage, LED count, or how widely it was distributed.
