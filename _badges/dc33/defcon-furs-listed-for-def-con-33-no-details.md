...
get_one:
  ...
  availability_note: 'The 2025 site says "Pre-orders until August 3rd 2025"; badges
    were also sold onsite at the DEFCON Furs events and at the Hacker Warehouse booth
    in the DEF CON vendor space, subject to availability. Live 2025.dcfurs.com/register
    checked 2026-09-06; it no longer offers a way to buy, and no sold-out statement was
    found.'
  distribution:
  - preorder
  - purchase
...
- kind: url
  ...
  note: 'Primary source: badge tiers/pricing ($150 assembled, $40 blank PCB), RP2040/36
    ...
    and the badge photo (assets/img/dcfurs-badge-2025-blank.jpg, alt "Picture of
    DEFCON Furs 2025 Badge PCB blank"). Fetched live on 2026-09-06.'
- kind: url
  url: https://dcfurs.com/
  title: DEFCON Furs
  accessed: '2026-09-06'
  note: 'Background on the group (furry-fandom meetup at DEF CON) and link to the
    2025 event site; no 2025-specific badge details on this page itself. Mentions
    the 2018 "Wrench Fox" boop badge as an earlier project.'
research:
  status: verified
  confidence: high
  last_checked: '2026-09-06'
  notes: 'Core specs and pricing come from the maker''s own 2025 registration page
    and were re-checked against the live page on 2026-09-06. Not found: LED part
    number, battery/power, firmware/hardware repo (the page only promises a GitHub
    post), and quantity made. Fact-check removed unsupported references to earlier
    badge names ("Cereal Booper", "Vixy"), a "membership" distribution tag, and a
    "security" theme; colors/shape were set from the saved PCB photo.'
