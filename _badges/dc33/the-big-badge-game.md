---
title: The Big Badge Game
id: dc33-the-big-badge-game
layout: badge
parent: DC33
...
summary: A gamified PCB badge from TheBadgES (Valencia, Spain) built around a "Rock, Paper, Scissors, Lizard, Spock" style game, sold exclusively to DEF CON 33 attendees for pickup at the conference.
functions: |-
  Get ready for a blast of strategy, geeky humor, and absolute chaos with our new gamified badge inspired by the legendary "Rock, Paper, Scissors, Lizard, Spock" from The Big Bang Theory.

  We've added an entropy generator that bends the rules of randomness and will leave jaws on the floor. Ready for calculated chaos?

  Think you can master the logic of madness? Grab the badge, challenge your crew, and show everyone you actually understood it on the first try.
look:
  colors: []
  shape: null
  themes:
