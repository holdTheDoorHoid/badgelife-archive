---
title: DC512 (listed for DEF CON 33, no details)
id: dc33-dc512-listed-for-def-con-33-no-details
layout: badge
parent: DC33
...
DC512 is the DEF CON group community for Austin, Texas, which meets regularly at Celis Brewery and was listed on the community sheet as an expected badge maker for DEF CON 33 (2025). No details about the sheet's row 34 entry accompanied the listing, and this pass could not locate a project page, storefront, repo, or press coverage describing an actual badge or SAO that DC512 produced or distributed for DEF CON 33.

This entry is left as `unknown` rather than filled in with a guess. If DC512 did release a badge for DEF CON 33, it may be documented on a members' personal page, a Discord/Meetup post that isn't indexed by search, or under a project name that doesn't include "DC512" directly — a future pass with working search access should retry before concluding none exists.
