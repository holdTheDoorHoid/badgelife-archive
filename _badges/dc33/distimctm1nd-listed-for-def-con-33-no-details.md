---
title: distimctm1nd (listed for DEF CON 33, no details)
id: dc33-distimctm1nd-listed-for-def-con-33-no-details
layout: badge
parent: DC33
...
make_your_own:
  ...
  eda_tool: null
links:
- label: github.com/distinctm1nd
  url: https://github.com/distinctm1nd
  kind: repo
- label: "Cabinet of Distinctm1nd (store)"
  url: https://ghoul.lol/
  kind: store
images: []
contact: {}
notes:
- "Sheet spells the maker's name 'distimctm1nd'; their own GitHub and storefront both spell it 'distinctm1nd'. Kept the sheet spelling in the title per the id/file name, but recorded the correct handle in makers."
status: unknown
sources:
- kind: sheet
  event: dc33
  ...
  updated: ''
- kind: url
  url: https://github.com/distinctm1nd?tab=repositories
  title: "distinctm1nd (GitHub repositories)"
  accessed: '2026-09-06'
  note: "Confirmed the maker's real handle (distinctm1nd, not the sheet's 'distimctm1nd') and listed their repos, none of which is clearly dated or labeled as a DEF CON 33 (2025) release."
- kind: url
  url: https://ghoul.lol/
  title: "Cabinet of Distinctm1nd (Shopify store)"
  accessed: '2026-09-06'
...
research:
  ...
  notes: >-
    The community sheet listed only a maker name for DEF CON 33, with no item details, and the
