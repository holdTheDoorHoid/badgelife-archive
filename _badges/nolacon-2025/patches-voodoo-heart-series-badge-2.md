...
id: nolacon-2025-patches-voodoo-heart-series-badge-2
layout: badge
parent: NolaCon 2025
...
year: 2025
makers:
- name: CylentK / cyl3ntkn1ght (NolaCon badge maker)
...
- label: CylentKnight/VoodooHeart (LED firmware)
  ...
  kind: repo
images:
- file: assets/images/badges/nolacon-2025/patches-voodoo-heart-series-badge-2/40fb4d6bf7.png
...
research:
  ...
  notes: 'Confirmed on the maker''s own NolaCon badge page and GitHub firmware repo. Series is stated as 3 installments total ("last year''s badge and next year''s final piece"); the prior badge (NolaCon 2024) has its own archive entry. Could not find MCU, LED count, display, price, quantity, or storefront/availability information anywhere; the maker has not published hardware files (schematic/PCB), only the LED firmware sketch. Appears to duplicate existing entry nolacon-2025-nolacon-2025-patches-badge; flagged for a maintainer to merge.'
