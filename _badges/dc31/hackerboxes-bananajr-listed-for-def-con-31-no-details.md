---
title: HackerBoxes/bananajr (listed for DEF CON 31, no details)
id: dc31-hackerboxes-bananajr-listed-for-def-con-31-no-details
layout: badge
parent: DC31
...
- label: hackerboxes.com
  ...
  kind: store
- label: 'Amulet of Entropy - the DC30 HackerBoxes/bananajr badge (for context)'
...
- kind: url
  url: https://github.com/h4ck3rb0x/DEFCON31
  title: 'HackerBoxes @ DEF CON 31 (GitHub README)'
  accessed: '2026-09-06'
  note: 'HackerBoxes'' own list of DC31 projects (DEF CON 31 Mini Badge, Cyber Power Disc Badge, SAO Totem, seven SAOs, toolkits); no mention of bananajr or a collaboration badge.'
- kind: url
...
- kind: url
  ...
  accessed: '2026-09-06'
  note: 'Published 2023-08-01; description reads "Learn to Solder at DEF CON 31"; no collaborator named.'
- kind: url
  url: https://www.youtube.com/watch?v=pNXoxo7XWYw
  title: 'Cyber Power Disc Badge Kit - HackerBoxes (YouTube)'
  accessed: '2026-09-06'
  note: 'Published 2023-08-02; assembly video only, no collaborator named.'
- kind: url
  url: https://forum.defcon.org/node/240869
  title: '2022 BadgeLife List has Started!! - DEF CON Forums'
  accessed: '2026-09-06'
  note: 'bananajr (profile "Author, Podcast Host") posts his first badge "developed with HackerBoxes.com", amuletofentropy.com, July 2022. Establishes who bananajr is.'
- kind: url
  url: https://forum.defcon.org/node/245049
  title: '2023 Badgelife List is Live!! - DEF CON Forums'
  accessed: '2026-09-06'
  note: 'DC31 badgelife thread; contains no post mentioning HackerBoxes or bananajr.'
- kind: url
  url: https://firewallsdontstopdragons.com/amulet-of-entropy/
  title: 'Amulet of Entropy - Firewalls Don''t Stop Dragons'
  accessed: '2026-09-06'
  note: 'Carey Parker''s page for the DC30 badge; no mention of a sequel or a DEF CON 31 item.'
- kind: url
  url: https://amuletofentropy.com/
  title: 'Amulet of Entropy'
  accessed: '2026-09-06'
  note: 'Landing page linking the DC30 badge''s docs, HackerBox #0080 and the GitHub repo; nothing for 2023.'
- kind: url
  url: https://github.com/FirewallDragon
  title: 'FirewallDragon (Carey Parker) on GitHub'
  accessed: '2026-09-06'
  note: 'Only one repository, amulet-of-entropy ("Software for the HackerBoxes #0080 project - a DEF CON indie badge"); no DC31 project.'
- kind: url
  url: https://hackerboxes.com/products/hackerbox-0080-entropy
  title: 'HackerBox #0080 - Entropy'
  accessed: '2026-09-06'
  note: 'The DC30 Amulet of Entropy kit, $79, sold out when checked; no DC31 reference.'
- kind: url
  url: https://hackerboxes.com/products/dc30-badge-bundle
  title: 'DC30 Badge Bundle - HackerBoxes'
  accessed: '2026-09-06'
  note: 'Confirms the Amulet of Entropy was the DC30 bundle item; no 2023 follow-up mentioned.'
- kind: url
