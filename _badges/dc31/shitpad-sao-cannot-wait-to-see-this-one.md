---
title: Sh*tPad SAO
id: dc31-shitpad-sao-cannot-wait-to-see-this-one
layout: badge
parent: DC31
...
summary: A ThinkPad-parody SAO from DC Punks styled as a shrunken IBM/Lenovo laptop, with a tiny screen that scrolls a fake Linux kernel x86 boot log forever and a bright white LED "keyboard backlight."
functions: Screen endlessly replays a Linux kernel x86 boot-log animation; a super-bright white LED lights the silkscreened keyboard "so you can type in the dark."
look:
  colors:
  - black
  - white
...
tech:
  ...
  leds:
    count: 1
    type: white LED
    note: Described by the maker as a "SUPER BRIGHT WHITE LED so you can type in the dark."
  display: small OLED
  connectivity: []
...
get_one:
  ...
  availability_note: Listed as "Sold out since Sep 09, 2023" on Tindie as of the 2026-09-07 check.
  distribution:
  - purchase
  where: Sold on Tindie by DC Punks (a rerun of an earlier "Sh*tPad SAO" run, brought back "2x the stock" for DEF CON 31).
make_your_own:
  open_source: null
  hardware_url: null
  firmware_url: null
...
- kind: url
  ...
  accessed: '2026-09-07'
  note: Confirms the maker duo and their Tindie store, though the live page only promotes their DEF CON 32 items, not this one.
research:
  status: researched
  confidence: high
...
It sold on Tindie for $23 and sold out by September 9, 2023, shortly after the con. No hardware or firmware files were found published for it, so it is documented here as closed/unknown on that front.
