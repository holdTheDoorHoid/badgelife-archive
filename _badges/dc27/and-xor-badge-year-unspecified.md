...
look:
  ...
  shape: null
  themes: [robot, sci-fi, cyberpunk, security, ctf, wearable]
tech:
  mcu: Rigado BMD-340 (nRF52840 core)
  leds: {count: null, type: RGB, note: 'IS31FL3741 LED controller driving RGB LEDs (HQ19-2333RGBC) behind light-pipe arcs'}
  display: none
  connectivity: [bluetooth, uart, usb]
