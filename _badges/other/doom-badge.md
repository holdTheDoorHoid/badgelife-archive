...
makers:
- name: avr
  url: https://hackaday.io/avr
summary: A wearable, Game Boy-shaped badge that runs id Software's DOOM on an ESP32, built for the 2018 Hackaday Prize.
...
research:
  ...
  notes: This is a 2018 Hackaday Prize / Open Hardware Design Challenge submission, not a badge made for a specific hacker con — event left as "other" since no matching con was found in events.yml. The project page shows development logs but no bill of materials, schematics, or firmware repo link, and no evidence it was ever manufactured beyond a prototype (no price, quantity, or sale/distribution info found). Not to be confused with the unrelated DEF CON "MicroDOOM" or "MF Doom SAO" entries already in the archive.
last_modified_date: '2026-09-07'
---

The DOOM Badge is a wearable electronic badge built by Hackaday.io user "avr" as an entry in the 2018 Hackaday Prize and Open Hardware Design Challenge. It runs id Software's DOOM on an ESP32 (WROOM module), driving an ST7735R LCD display, and is powered by a 3.7V LiPo battery with USB charging. The PCB is shaped like a classic Game Boy, a deliberate nod to retro handheld and IBM-PC-era computer aesthetics, and includes expansion I/O for external I2C peripherals.
