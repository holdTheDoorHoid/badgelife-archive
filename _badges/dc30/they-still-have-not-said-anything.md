---
title: They still have not said anything...
id: dc30-they-still-have-not-said-anything
layout: badge
parent: DC30
...
year: 2022
makers:
- name: Darknet (received word they are making one)
summary: ''
functions: ''
look:
  colors: []
...
research:
  ...
  notes: Could not confirm any details beyond the sheet's own rumor. The sheet row itself says only that word was received "Darknet" (the DEF CON contest group later renamed Darknet-NG) was making a badge for DEF CON 30 (2022), with a guessed price ceiling of $100 and no other specifics. Darknet-NG's current website (darknet-ng.network) has badge write-ups going back only to DEF CON 31 (2023) — its full post sitemap has no DEF CON 30 or 2022 entry — and the only Wayback Machine snapshot from around that time (May 2022) shows the site as "under maintenance" with no badge content. No Hackaday, GitHub, Twitter/X, or press coverage of a 2022 Darknet badge was found. It is unclear whether the badge was ever released, released under a different/undocumented name, or never materialized. Leaving all descriptive fields empty per the never-invent rule; title kept as the sheet's own commentary since no actual badge name was found to replace it with.
