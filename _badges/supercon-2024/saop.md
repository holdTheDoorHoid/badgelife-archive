...
make_your_own:
  ...
  eda_tool: KiCad
links:
- label: github.com/cgnd/saop
  url: https://github.com/cgnd/saop
  kind: repo
- label: github.com/common-ground-electronics/saop
  url: https://github.com/common-ground-electronics/saop
  kind: repo
- label: hackaday.io/project/198497-saop
  url: https://hackaday.io/project/198497-saop
  kind: hackaday
...
- kind: url
  url: https://github.com/cgnd/saop
  title: SAOP - Just a cute bar of SAOP
  accessed: '2026-09-06'
  note: Found via the project's link list; intake pass identified this item here.
- kind: url
  url: https://hackaday.io/project/198497-saop
  title: SAOP project page (Hackaday.io)
  accessed: '2026-09-07'
  note: Confirmed maker (Chris Wilson), event (Supercon 8 Add-On Contest, 2024), and the joke premise ("Sanitation And Oral Purifier").
- kind: url
  url: https://raw.githubusercontent.com/cgnd/saop/main/README.md
  title: saop README
  accessed: '2026-09-07'
