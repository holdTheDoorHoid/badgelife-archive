---
title: Application Security Community Badge
id: saintcon-2023-application-security-community-badge
layout: badge
...
year: 2023
makers:
- name: AppSec Community (SAINTCON)
  url: https://saintcon.zip/SAINTCON_2023/saintcon.org/com-appsec-community/
summary: A minibadge given out at the SAINTCON 2023 AppSec Community booth; the community's own page never published its design before the event.
functions: ''
look:
  colors: []
  shape: null
...
get_one:
  ...
  distribution:
  - free_drop
  where: Given out at the SAINTCON 2023 AppSec Community booth to attendees who visited.
make_your_own:
  open_source: null
  hardware_url: null
  firmware_url: null
...
- label: saintcon.zip/SAINTCON_2023/saintcon.org/wp-content/uploads/2023/10/2023_Minibadge_Guide_10.31.2023.pdf
  ...
  kind: website
- label: 'COM - AppSec Community - SAINTCON 2023'
  url: https://saintcon.zip/SAINTCON_2023/saintcon.org/com-appsec-community/
  kind: website
images: []
contact: {}
notes:
- 2023 AppSec Community minibadge (distinct from the separate 2023 AppSec Challenge contest badge). Found by the event-year sweep, task saintcon-2023.
- 'The sweep credited maker "SHIFTY"; SHIFTY co-leads SAINTCON''s overall MiniBadge community program, not this specific AppSec Community booth. The AppSec Community''s own 2023 page names its leads as sketrik and l4wke, but does not say who designed this minibadge, so makers was changed to the community itself rather than guessing an individual.'
status: listed
sources:
- kind: url
  url: https://saintcon.zip/SAINTCON_2023/saintcon.org/wp-content/uploads/2023/10/2023_Minibadge_Guide_10.31.2023.pdf
