---
title: TFHT - THE TRUTH IS OUT THERE...
id: saintcon-2023-tfht-the-truth-is-out-there
layout: badge
...
tech:
  ...
  leds:
    count: null
    type: null
    note: LEDs present; single-pad hand-soldering method specified. Exact count/type not stated.
  display: none
  connectivity: []
  battery: null
  sao_version: null
get_one:
  ...
  distribution: []
  where: How to acquire was listed on the community sheet only as "~REDACTED INFORMATION~" — no distribution details available.
make_your_own:
  open_source: null
  hardware_url: null
  firmware_url: null
  eda_tool: null
links:
- label: minibadge.wiki/?search=TFHT%20-%20THE%20TRUTH%20IS%20OUT%20THERE...&year=2023
  url: https://minibadge.wiki/?search=TFHT%20-%20THE%20TRUTH%20IS%20OUT%20THERE...&year=2023
  kind: website
images:
- file: assets/images/badges/saintcon-2023/tfht-the-truth-is-out-there/cf86e4b765.png
  source: https://minibadge.wiki/2023.json
  credit: SHIFTY
  caption: Front of the TFHT minibadge
  archived: https://web.archive.org/web/20260611102022/http://minibadge.wiki/2023.json
- file: assets/images/badges/saintcon-2023/tfht-the-truth-is-out-there/d4435d4e34.png
  source: https://minibadge.wiki/2023.json
  credit: SHIFTY
  caption: Back of the TFHT minibadge
  archived: https://web.archive.org/web/20260611102022/http://minibadge.wiki/2023.json
contact: {}
notes:
...
- kind: url
  ...
  title: MiniBadge Wiki 2023 data (JSON record for TFHT - THE TRUTH IS OUT THERE...)
  accessed: '2026-09-07'
