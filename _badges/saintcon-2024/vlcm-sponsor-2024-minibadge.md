---
title: VLCM-Sponsor-2024 minibadge
id: saintcon-2024-vlcm-sponsor-2024-minibadge
layout: badge
...
makers:
- name: VLCM
  url: https://www.vlcm.com/
summary: A sponsor-branded SAINTCON 2024 minibadge for VLCM, a Utah IT/security reseller that sponsored the conference.
functions: ''
look:
  colors: []
  shape: null
...
make_your_own:
  ...
  eda_tool: null
links:
- label: github.com/utahsaint-org/MiniBadges2024/tree/main/VLCM-Sponsor-2024
  url: https://github.com/utahsaint-org/MiniBadges2024/tree/main/VLCM-Sponsor-2024
  kind: repo
- label: VLCM (vlcm.com)
  url: https://www.vlcm.com/
  kind: website
...
contact: {}
notes:
- VLCM sponsor-branded minibadge for SAINTCON 2024. Found by the event-year sweep, task saintcon-2024.
- Sheet/repo folder name was "VLCM-Sponsor-2024"; kept as the title with light formatting.
status: listed
sources:
- kind: url
  url: https://github.com/utahsaint-org/MiniBadges2024/tree/main/VLCM-Sponsor-2024
...
- kind: url
  url: https://github.com/utahsaint-org/MiniBadges2024/tree/main/VLCM-Sponsor-2024
  title: VLCM-Sponsor-2024 folder contents
  accessed: '2026-09-10'
  note: 'Folder contains only two design/artwork files (Sprite-0001.svg, VLCM.ai) — no PCB, gerber, BOM, or firmware files; no README or description text on the page.'
- kind: url
...
research:
  ...
  notes: >-
    ...
    simple printed/laser-cut sponsor token. No storefront, price, quantity, or availability
    information was found anywhere (SAINTCON minibadges are generally traded/given at the
    con rather than sold, but that is not confirmed for this specific badge). No photo of
    the assembled/finished badge was found; only the flat design artwork exists, and it is
    an SVG (fetch_image.py could not save it as a raster image). Left tech.*, look.colors,
    look.shape, get_one.* as null/empty rather than guess from the design-source colors,
    which may not match the final production badge.
