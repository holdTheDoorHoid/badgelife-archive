...
makers:
- name: Mister X
summary: 'A SAINTCON 2024 minibadge from a Sea of Thieves-themed set, styled after the game''s Reaper''s Bones faction emblem, awarded only for completing three of the set''s other faction minibadges.'
