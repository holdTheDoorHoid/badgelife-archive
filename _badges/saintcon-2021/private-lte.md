...
makers:
- name: Jup1t3r
summary: A SAINTCON 2021 minibadge built around a single through-hole LED and a resistor.
functions: ''
look:
  colors: []
  shape: null
...
tech:
  ...
  leds:
    count: 1
    type: discrete
    note: Single through-hole LED pressed through the large hole; must not be reversed or it will be destroyed.
  display: none
  connectivity: []
  battery: null
  sao_version: none
...
make_your_own:
  ...
  eda_tool: null
links:
- label: minibadge.wiki/?search=PRIVATE%20LTE&year=2021
  url: https://minibadge.wiki/?search=PRIVATE%20LTE&year=2021
  kind: website
images:
- file: assets/images/badges/saintcon-2021/private-lte/68918ba72a.jpg
  source: "https://minibadge.wiki/?search=PRIVATE%20LTE&year=2021"
  credit: "Jup1t3r"
  caption: "Front of the PRIVATE LTE minibadge"
contact: {}
notes: []
status: listed
sources:
