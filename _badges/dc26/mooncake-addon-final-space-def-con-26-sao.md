...
summary: A #badgelife "shitty addon" (SAO) shaped like Mooncake, the character from the animated series Final Space, made for DEF CON 26 (2018).
...
- kind: url
  ...
  accessed: '2026-09-07'
  note: Confirms it is a #badgelife shitty addon (SAO) shaped after Mooncake from Final Space, made for DEF CON 26 (2018) by d4rkwyng with help from AND!XOR and SparX. Gives BOM (MCP23017 I/O expander, 10x 1206 LEDs, 10x 220-ohm resistors, 0.1uF cap, 2x2 shitty connector), three PCB revisions (A, B, C/C ESO), and confirms MIT-licensed KiCad design files, gerbers, and BOM are in the repo.
research:
  status: researched
  confidence: high
