...
id: dc34-badgelife-village-badge
layout: badge
parent: DC34
grand_parent: Badge Archive
nav_exclude: true
redirect_from:
- /badges/dc34/villagebadge/
- /badge
type: badge
event: dc34
year: 2026
...
- name: Jeff "BigTaro"
  ...
  role: designer
- name: Badgelife Village
  url: https://badge.life
summary: 'Badgey Bodgerton, the official DEF CON 34 Badgelife Village badge: a finish-it-yourself CTF badge with an RP2354, eight NeoPixels, an IR receiver, a USB serial CLI and two SAO v2 headers.'
functions: Serial CLI CTF with challenges that require soldering a bodge wire, an LED, a resistor and a buzzer; brightness unlock; IR receiver; UF2 firmware updates.
look:
  colors: []
  shape: character (Badgey Bodgerton)
  themes:
  - mascot
  - village badge
  - solder-it-yourself
tech:
  mcu: RP2354 (RP2350 family, integrated flash)
  leds:
    count: 8
    type: addressable RGB NeoPixel
  display: null
  connectivity:
  - IR receiver
  - USB-C (CDC serial)
  ...
  power: USB-C
  battery: single 18650 cell with charging and protection
  sao_version: v2 (v1.69bis)
  sao_ports: 2
get_one:
  price: ''
  price_usd: null
  ...
  distribution:
  - village
  where: Badgelife Village at DEF CON 34
make_your_own:
  open_source: partial
  hardware_url: null
  firmware_url: null
  eda_tool: null
  notes: Prebuilt UF2 firmware 1.0.1 is mirrored here; the badge firmware source was announced for release after the con.
links:
- label: Badge help and updates (badge.life/badge)
  url: https://badge.life/badge
  kind: website
...
- label: BigTaro
  ...
  kind: website
images:
- file: assets/images/badges/dc34/badgelife-village-badge/badge-rotate.gif
  source: https://badge.life/badges/dc34/villagebadge/
  credit: Badgelife Village / BigTaro
  caption: Front of the Badgelife Village Badge
- file: assets/images/badges/dc34/badgelife-village-badge/badge_front.png
  source: https://badge.life/badges/dc34/villagebadge/
  credit: Badgelife Village / BigTaro
  caption: Badge front
contact: {}
...
sources:
- kind: url
  url: https://badge.life/badges/dc34/villagebadge/
...
research:
  ...
  notes: Specifications and build guide come directly from the Badgelife Village's own documentation on badge.life.
...
## Firmware Updates
* Version 1.0.1 [[Download]]({{ site.baseurl }}/assets/files/badgelife-village-badge-firmware1.0.1.uf2) Changes:
